...
// Function to implement the join query
// This join query retrieves data from two related tables: Player and PlayerGame. 
// It combines data from both tables to create a comprehensive view of the relationships between players and games, including their scores. 
function readPlayerGames(req, res, next) {
  db.many(`
      SELECT p.id AS player_id, p.name AS player_name, pg.gameID, pg.score
      FROM Player p
